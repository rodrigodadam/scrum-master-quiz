...
// To create a secure service and avoid that the player change the scores into a Dev Tools, the best way is creating and storing the data into a Server/DB and not into a storage.
